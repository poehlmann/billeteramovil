    ...
    return function () {
        ...
        1: [function (a, d, b) {
            var e = a("object-assign"), c = a("component-query"), m = a("get-doc"), f = a("cookie-cutter"), n = a("ua-parser-js"), k = (navigator.language || navigator.userLanguage || navigator.browserLanguage).slice(-2) || "us", r = m && m.documentElement, g = {
                ios: {
                    appMeta: "apple-itunes-app", iconRels: ["apple-touch-icon-precomposed",
                        ...
                        return "https://apps.apple.com/es/app/soli-pagos-bcp/id1135987447"
                    }
                }, android: {
                    appMeta: "google-play-app", iconRels: ["android-touch-icon", "apple-touch-icon-precomposed", "apple-touch-icon"], getStoreLink: function () {
                        return "https://play.google.com/store/apps/details?id=com.bcp.bo.wallet&referrer=utm_source%3Dp%25C3%25A1gina_web%26utm_medium%3Dp%25C3%25A1gina_web%26utm_term%3Dp%25C3%25A1gina_web%26utm_content%3Dp%25C3%25A1gina_web%26utm_campaign%3Dp%25C3%25A1gina_web"
                    }
                }, windows: {
            ...
            a = function (a) {
                ...
                this.options = e({}, {daysHidden: 15, daysReminder: 90, appStoreLanguage: k, button: "OPEN", store: {ios: "On the App Store", android: "In Google Play", windows: "In the Windows Store"}, price: {ios: "FREE", android: "FREE", windows: "FREE"}, theme: "", icon: "", force: ""}, a || {});
                ...
                if (this.type && this.options.store[this.type]) {
                    ...
                    var l = navigator.standalone, b = f.get(this.appId + "-smartbanner-closed"), d = f.get(this.appId + "-smartbanner-installed");
            ...
            a.prototype = {
                constructor: a, create: function () {
                    ...
                    t.innerHTML = '<div class="smartbanner-container"><a href="javascript:void(0);" id="smart_banner_cerrar" class="smartbanner-close">&times;</a><span class="smartbanner-icon" style="background-image: url(' +
                        f + ')"></span><div class="smartbanner-info"><div class="smartbanner-title">' + this.options.title + "</div><div>" + this.options.author + "</div><span>" + e + '</span></div><a rel="noreferrer" target="_blank" id="descarga_smart_banner" href="' + a + '" class="smartbanner-button"><span class="smartbanner-button-text">' + this.options.button + "</span></a></div>";
            ...
            d.exports = a
        }, {"component-query": 2, "cookie-cutter": 3, "get-doc": 4, "object-assign": 6, "ua-parser-js": 7}], 2: [function (a, d, b) {
            function e(a, e) {
        ...
        }, {"has-dom": 5}], 5: [function (a, d, b) {
            d.exports = function () {
                return "undefined" !==
                    typeof window && "undefined" !== typeof document && "function" === typeof document.createElement
            }
        }, {}], 6: [function (a, d, b) {
            var e = Object.getOwnPropertySymbols, c = Object.prototype.hasOwnProperty, m = Object.prototype.propertyIsEnumerable;
            d.exports = function () {
                try {
            ...
            (function (a, c) {
                var e = {
                    ...
                    var l = b || (a && a.navigator && a.navigator.userAgent ? a.navigator.userAgent : ""), k = d ? e.extend(r, d) : r;
                ...
                g.DEVICE = {MODEL: "model", VENDOR: "vendor", TYPE: "type", CONSOLE: "console", MOBILE: "mobile", SMARTTV: "smarttv", TABLET: "tablet", WEARABLE: "wearable", EMBEDDED: "embedded"};
